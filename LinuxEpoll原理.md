...
我们直接从[服务器](https://cloud.tencent.com/act/pro/promotion-cvm?from_column=20065&from=20065)端的 accept 讲起。当 accept 之后，进程会创建一个新的 socket 出来，专门用于和对应的客户端通信，然后把它放到当前进程的打开文件列表中。

![img](https://ask.qcloudimg.com/http-save/yehe-1112333/6d79782106f091c0a775e1afcaecc791.png)

其中一条连接的 socket 内核对象更为具体一点的结构图如下。

![img](https://ask.qcloudimg.com/http-save/yehe-1112333/2d44fdfd14bb4bd8bd85e6b049b1e488.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/4bb68cd8b2515898e80c2bfc6db38274.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/ac7a3f1c4772354ce3442f06df4af2fd.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/12b74a956e5b489b441ea3de401cb8af.png)

对于 struct eventpoll 对象，更详细的结构如下（同样只列出和今天主题相关的成员）。

![img](https://ask.qcloudimg.com/http-save/yehe-1112333/b8b3c13f7fd104a2041e67c96aa367ae.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/d57bc1eed46225119185d1127c1e4dff.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/0a1d62315540e8a821910e307e66ad5c.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/8125e415409915c71ee44f86f7730e08.png)
...
在前文 [**深入理解高性能网络开发路上的绊脚石 - 同步阻塞网络 IO**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMjM5Njg5NDgwNA%3D%3D%26mid%3D2247484834%26idx%3D1%26sn%3Db8620f402b68ce878d32df2f2bcd4e2e%26scene%3D21%23wechat_redirect&source=article&objectId=1964472) 里阻塞式的系统调用 recvfrom 里，由于需要在数据就绪的时候唤醒用户进程，所以等待对象项的 private (这个变量名起的也是醉了) 会设置成当前用户进程描述符 current。而我们今天的 socket 是交给 epoll 来管理的，不需要在一个 socket 就绪的时候就唤醒进程，所以这里的 `q->private` 没有啥卵用就设置成了 NULL。
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/1eb86ee6f4317f3537ecf8d7ec484554.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/9c01940ad6609d5721263695579b4601.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/3ed0d0350ded9f9506e39eb91e8ee28a.png)
...
关于软中断是怎么处理网络帧，为了避免篇幅过于臃肿，这里不再介绍。感兴趣的可以看文章 [**《图解Linux网络包接收过程》**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMjM5Njg5NDgwNA%3D%3D%26mid%3D2247484058%26idx%3D1%26sn%3Da2621bc27c74b313528eefbc81ee8c0f%26scene%3D21%23wechat_redirect&source=article&objectId=1964472)。我们今天直接从 tcp 协议栈的处理入口函数 tcp_v4_rcv 开始说起。
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/05cd68bdb185e54c9dd2c6ad570abc68.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/4f01419cb16326a0e36cd74ea57ae28f.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/3eff93e6f69d6e6e7128b0af27a0a79b.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/ef4beafee40d745090a7c5a6f126129f.png)
...
![img](https://ask.qcloudimg.com/http-save/yehe-1112333/9000bff1f3d5cd7ed320881f7c9dd847.png)
...
- [**图解 | Linux 网络包接收过程**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMjM5Njg5NDgwNA%3D%3D%26mid%3D2247484058%26idx%3D1%26sn%3Da2621bc27c74b313528eefbc81ee8c0f%26scene%3D21%23wechat_redirect&source=article&objectId=1964472)
- [**图解 | 深入理解高性能网络开发路上的绊脚石 - 同步阻塞网络 IO**](https://cloud.tencent.com/developer/tools/blog-entry?target=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMjM5Njg5NDgwNA%3D%3D%26mid%3D2247484834%26idx%3D1%26sn%3Db8620f402b68ce878d32df2f2bcd4e2e%26scene%3D21%23wechat_redirect&source=article&objectId=1964472)
...
本文来源: https://cloud.tencent.com/developer/article/1964472